...
@section('content')
    <section class="process-ca section-padding bg-light radius-20 mt-15 ontop">
        ...
        <div class="">
                        ...
                        @if ($timeline->type == 'child_birth')
                            <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24"
                                ...
                                <path
                                    ...
                                    stroke="#24cdd5" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M15.5 9C15.4867 7.35641 14.1436 6.01326 12.5 6" stroke="#24cdd5" stroke-width="1.5"
            ...
            <form action="{{ route('timelines.updateAll') }}" method="POST">
                @csrf
                <input type="hidden" name="memorial_id" value="{{ $memorial->id }}">
                ...
                @foreach ($timelines as $timeline)
                    <div class="tracking-item">
                        <input type="hidden" name="timelines[{{ $timeline->id }}][id]" value="{{ $timeline->id }}">
