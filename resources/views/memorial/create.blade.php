                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-7 mb-3">
                                ...
                                <!-- Скрытое поле для отправки объединенной даты -->
                                <input type="hidden" id="death_date" name="death_date"
                            ...
                            <div class="col-12 col-md-5 mb-3">
                                ...
                                <input type="text" id="grave_location" value="{{ old('grave_location') }}"
                                    ...
                                    placeholder="{{ __('Enter the place name') }}" name="grave_location">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-12 col-md-7 p-3">
                    ...
                    <div class="container mt-50">
                        ...
                        <textarea id="biography" oninput="updateCharCount()" maxlength="5000"
                            class="form-control @error('biography') is-invalid @enderror" name="biography" rows="7">{{ old('biography') }}</textarea>
