        ...
        <div class="container">
            ...
            <div class="row boxs">
                <div class="col-lg-7 offset-lg-5">
                    <div class="d-flex">
                        <div class="item text-center bg-color" style="background-image: url('home/imgs/intro/1.png'); background-size: cover; background-position: center; min-height: 260px;">
                            <!-- <h2>80</h2>
                            <h6>Project Completed</h6> -->
                        </div>
                        <div class="item text-center bg-light" style="background-image: url('home/imgs/intro/2.png'); background-size: cover; background-position: center;">
                            <!-- <h2>17k</h2>
